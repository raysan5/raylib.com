$(document).ready(function() {
    ...
    var exampleData = [
        ...
        exampleEntry('⭐️☆☆☆' , 'models'  , 'gpu_skinning'),
        ...
        exampleEntry('⭐️☆☆☆' , 'models'  , 'point_rendering'),
        ...
        exampleEntry('⭐️⭐️☆☆' , 'models'  , 'tesseract_view'),
        ...
        exampleEntry('⭐️⭐️⭐️⭐️' , 'shaders' , 'vertex_displacement'),
