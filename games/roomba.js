...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'roomba.data';
    var REMOTE_PACKAGE_BASE = 'roomba.data';
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_roomba.data');

    };
    Module['addRunDependency']('datafile_roomba.data');
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'roomba.wast';
  var wasmBinaryFile = 'roomba.wasm';
  var asmjsCodeFile = 'roomba.temp.asm.js';
