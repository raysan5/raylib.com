...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'models/models_first_person_maze.data';
  ...
  Module['FS_createPath']('/', 'resources', true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_models/models_first_person_maze.data');

      };
      Module['addRunDependency']('datafile_models/models_first_person_maze.data');
   ...
   loadPackage({"files": [{"filename": "/resources/cubicmap.png", "start": 0, "end": 201, "audio": 0}, {"filename": "/resources/cubicmap_atlas.png", "start": 201, "end": 37426, "audio": 0}], "remote_package_size": 37426, "package_uuid": "41ddaf2d-de45-46a8-82a8-49135fa70e79"});
...
var STACK_BASE = 5284032,
    STACKTOP = STACK_BASE,
    STACK_MAX = 41152,
    DYNAMIC_BASE = 5284032;
...
var wasmBinaryFile = 'models_first_person_maze.wasm';
