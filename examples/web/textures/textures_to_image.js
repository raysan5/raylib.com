...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'textures/textures_to_image.data';
...
Module['FS_createPath']('/', 'resources', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_textures/textures_to_image.data');

    };
    Module['addRunDependency']('datafile_textures/textures_to_image.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 3760, "filename": "/resources/raylib_logo.png"}], "remote_package_size": 3760, "package_uuid": "4a05c488-1488-40c8-96c3-e1005889fc40"});
