...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'textures/textures_image_text.data';
...
Module['FS_createPath']('/', 'resources', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_textures/textures_image_text.data');

    };
    Module['addRunDependency']('datafile_textures/textures_image_text.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 295054, "filename": "/resources/parrots.png"}, {"start": 295054, "audio": 0, "end": 374966, "filename": "/resources/KAISG.ttf"}], "remote_package_size": 374966, "package_uuid": "a41782c4-ba6a-4923-a611-f7b0293cc800"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5278336,
    DYNAMIC_BASE = 5278336,
    DYNAMICTOP_PTR = 35424;
...
var wasmBinaryFile = 'textures_image_text.wasm';
...
// {{PRE_LIBRARY}}
  ...
  var GLFW={Window:function(id, width, height, title, monitor, share) {
        ...
        if (!win) return;
        win.dropFunc = cbfun;
        console.log("--->LOG: setDropCallback assigned!");
      },onDrop:function(event) {
          
        console.log("--->LOG: OnDrop: GO!");
          
        if (!GLFW.active || !GLFW.active.dropFunc) return;
        if (!event.dataTransfer || !event.dataTransfer.files || event.dataTransfer.files.length == 0) return;
  
        console.log("--->LOG: OnDrop: STEP1");
        
        event.preventDefault();
  
  //#if '$FS' in addedLibraryItems
  
        console.log("--->LOG: OnDrop: STEP2");
  ...
  function _glfwSetDropCallback(winid, cbfun) {
      ...
      console.log("--->LOG: glfwSetDropCallback set!");
    }
