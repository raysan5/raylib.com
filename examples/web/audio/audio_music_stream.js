...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'audio/audio_music_stream.data';
...
Module['FS_createPath']('/', 'resources', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_audio/audio_music_stream.data');

    };
    Module['addRunDependency']('datafile_audio/audio_music_stream.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 1, "end": 506938, "filename": "/resources/guitar_noodling.ogg"}], "remote_package_size": 506938, "package_uuid": "98e7fe38-8bc6-46aa-835a-9efc4f3a2a67"});
...
var wasmBinaryFile = 'audio_music_stream.wasm';
