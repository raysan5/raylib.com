...
// include: C:\Users\ethan\AppData\Local\Temp\tmp_dzhsd_5.js
...
Module['FS_createPath']("/", "resources", true, true);
    ...
    loadPackage({"files": [{"filename": "/resources/pixantiqua.fnt", "start": 0, "end": 21274}, {"filename": "/resources/pixantiqua.png", "start": 21274, "end": 25805}, {"filename": "/resources/pixantiqua.ttf", "start": 25805, "end": 61213}], "remote_package_size": 61213});

  })();

// end include: C:\Users\ethan\AppData\Local\Temp\tmp_dzhsd_5.js
// include: C:\Users\ethan\AppData\Local\Temp\tmpkhlx4t77.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\ethan\AppData\Local\Temp\tmpkhlx4t77.js
// include: C:\Users\ethan\AppData\Local\Temp\tmp65g32kry.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\ethan\AppData\Local\Temp\tmp65g32kry.js
...
var ASM_CONSTS = {
  107662: () => { if (document.fullscreenElement) return 1; },  
 107708: () => { return Module.canvas.width; },  
 107740: () => { return parseInt(Module.canvas.style.width); },  
 107788: () => { document.exitFullscreen(); },  
 107815: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 107887: () => { if (document.fullscreenElement) return 1; },  
 107933: () => { return Module.canvas.width; },  
 107965: () => { return screen.width; },  
 107990: () => { document.exitFullscreen(); },  
 108017: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 108211: () => { return window.innerWidth; },  
 108237: () => { return window.innerHeight; },  
 108264: () => { if (document.fullscreenElement) return 1; },  
 108310: () => { return Module.canvas.width; },  
 108342: () => { return parseInt(Module.canvas.style.width); },  
 108390: () => { if (document.fullscreenElement) return 1; },  
 108436: () => { return Module.canvas.width; },  
 108468: () => { return screen.width; },  
 108493: () => { return window.innerWidth; },  
 108519: () => { return window.innerHeight; },  
 ...
 108676: () => { if (document.fullscreenElement) return 1; },  
 108722: () => { return Module.canvas.width; },  
 108754: () => { return parseInt(Module.canvas.style.width); },  
 108802: () => { document.exitFullscreen(); },  
 108829: ($0) => { Module.canvas.style.opacity = $0; },  
 108867: () => { return screen.width; },  
 108892: () => { return screen.height; },  
 108918: () => { return window.screenX; },  
 108945: () => { return window.screenY; },  
 108972: () => { return window.devicePixelRatio; },  
 109008: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 109061: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 109112: () => { Module.canvas.style.cursor = 'none'; },  
 109149: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 109405: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 109456: () => { if (document.pointerLockElement) return 1; },  
 109503: () => { if (document.fullscreenElement) return 1; },  
 109549: () => { return window.innerWidth; },  
 109575: () => { return window.innerHeight; }
};
...
function assignWasmExports(wasmExports) {
  ...
  dynCall_fffi = dynCalls['fffi'] = createExportWrapper('dynCall_fffi', wasmExports['dynCall_fffi'], 4);
  dynCall_ffi = dynCalls['ffi'] = createExportWrapper('dynCall_ffi', wasmExports['dynCall_ffi'], 3);
